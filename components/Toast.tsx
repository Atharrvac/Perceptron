...
const Toast: React.FC<ToastProps> = ({ message, type, duration = 5000, onClose }) => {
  ...
  const getToastStyles = () => {
    const baseStyles = 'fixed top-4 right-4 z-50 max-w-sm w-full px-6 py-4 rounded-lg shadow-xl border transform transition-all duration-300 ease-in-out';
    ...
    switch (type) {
      ...
      default:
        return `${baseStyles} bg-slate-700 border-slate-600 text-white`;
    }
  };
